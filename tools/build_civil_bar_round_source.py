...
def classify_subject(round_no: int, question_no: int) -> str:
    if round_no == 2:
        ...
        return "\ubbfc\ubc95"
    if round_no == 3:
        commercial = {*range(36, 53), 69, 70}
        civil_procedure = set(range(53, 69))
        if question_no in commercial:
            return "\uc0c1\ubc95"
        if question_no in civil_procedure:
            return "\ubbfc\uc0ac\uc18c\uc1a1\ubc95"
        return "\ubbfc\ubc95"
    if round_no == 4:
        commercial = {*range(36, 53), 57, 66, 68, 70}
        civil_procedure = {53, 54, 56, 59, 60, 61, 62, 63, 64, 65, 69}
        if question_no in commercial:
            return "\uc0c1\ubc95"
        if question_no in civil_procedure:
            return "\ubbfc\uc0ac\uc18c\uc1a1\ubc95"
        return "\ubbfc\ubc95"
    if round_no == 5:
        commercial = {*range(36, 53), 63, 65, 66, 67}
        civil_procedure = {53, 54, 59, 60, 61, 62, 64, 68, 69, 70}
        if question_no in commercial:
            return "\uc0c1\ubc95"
        if question_no in civil_procedure:
            return "\ubbfc\uc0ac\uc18c\uc1a1\ubc95"
        return "\ubbfc\ubc95"
    if round_no == 6:
        commercial = {*range(36, 53), 62, 67}
        civil_procedure = {53, 54, 55, 56, 57, 58, 59, 60, 61, 63, 68, 69}
        if question_no in commercial:
            return "상법"
        if question_no in civil_procedure:
            return "민사소송법"
        return "민법"
    if round_no == 7:
        commercial = {*range(36, 53), 70}
        civil_procedure = {53, 54, 55, 56, 57, 58, 59, 60, 62, 64, 66, 67, 68, 69}
        if question_no in commercial:
            return "상법"
        if question_no in civil_procedure:
            return "민사소송법"
        return "민법"
    if round_no == 8:
        commercial = {*range(36, 53), 59, 67, 69, 70}
        civil_procedure = {53, 56, 57, 58, 60, 63, 64, 65, 66, 68}
        if question_no in commercial:
            return "상법"
        if question_no in civil_procedure:
            return "민사소송법"
        return "민법"
    if round_no == 9:
        commercial = {*range(36, 53), 56, 58, 67, 70}
        civil_procedure = {53, 54, 55, 59, 61, 62, 63, 64, 65, 66, 68, 69}
        if question_no in commercial:
            return "상법"
        if question_no in civil_procedure:
            return "민사소송법"
