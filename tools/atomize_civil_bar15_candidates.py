...
MANUAL_REP_OVERRIDES_BY_ROUND = {
    11: {
        (4, "ㅁ"): "사해행위취소소송의 사실심 변론종결시에 채무자가 자력을 회복하여 채권자를 해하지 않게 되면, 법원은 채무자의 당사자적격 흠결을 이유로 소를 각하하여야 한다.",
        (18, "①"): "양도담보권자는 담보목적물을 무단점유하는 제3자에게 목적물 인도를 청구할 수 있다.",
        (18, "⑤"): "양도담보 목적물에 제3자 소유 동산이 부합된 경우, 제3자는 양도담보권자에게만 첨부로 인한 보상을 청구할 수 있고 양도담보설정자에게는 청구할 수 없다.",
        (26, "ㄹ"): "계약서에 표시된 지번이 양 당사자의 실제 의사와 다르면, 당사자의 진의가 일치하더라도 계약서 표시 지번의 토지에 관한 매매계약이 성립한다.",
        (31, "②"): "협의 또는 심판에 따라 구체화되지 않은 재산분할청구권은 채무자의 책임재산에 해당하지 않으므로, 그 포기는 채권자취소권의 대상이 되지 않는다.",
        (32, "③"): "자필증서에 의한 유언은 증인의 서명 또는 기명날인이 없으면 무효이다.",
        (34, "①"): "변제충당 합의나 지정이 없는 이 사안에서 2억 원은 두 차용금에 1억 원씩 균등하게 충당된다.",
        (34, "②"): "변제충당 합의나 지정이 없는 이 사안에서 2억 원은 고이율 무담보 차용금에 8,100만 원, 보증 있는 차용금에 1억 1,900만 원씩 충당된다.",
        (34, "③"): "변제충당 합의나 지정이 없는 이 사안에서 2억 원은 고이율 무담보 차용금에 1억 7,200만 원, 보증 있는 차용금에 2,800만 원씩 충당된다.",
        (34, "④"): "변제충당 합의나 지정이 없으면 먼저 이자 전액에 충당하고, 남은 금액은 변제이익이 큰 고이율 무담보 원본에 우선 충당한다.",
        (34, "⑤"): "변제충당 합의나 지정이 없는 이 사안에서 보증 있는 차용금에는 아무 금액도 충당되지 않고 전액이 고이율 무담보 차용금에 충당된다.",
        (36, "②"): "배우자가 사망하고 생존 배우자가 재혼하지 않았으면 생계를 달리하는 시부모에 대한 부양의무가 계속된다.",
        ...
        (54, "③"): "회사채권자는 영업시간 내에 회사의 이사회 의사록 열람 또는 등사를 청구할 수 있다.",
        (63, "④"): "소유권이전등기청구권 가압류 후 채무자가 제3자에게 부동산 소유권을 이전한 경우, 가압류채권자는 제3자 명의 소유권이전등기가 가압류에 저촉되어 원인무효임을 이유로 말소를 청구할 수 있다.",
    },
    12: {
